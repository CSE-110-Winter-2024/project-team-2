...
public class RoomGoalRepositoryTest {
    ...
    public void observeAppendGoal() {
        ...
        goalRepository.append(new Goal(null, "goal1", 1, false, null, true, Calendar.getInstance(), false,
                GoalContext.getGoalContextById(1), 0, Goal.RecurrencePattern.NONE, null, null));
    ...
    public void observeUpdateGoal() {
        Goal goal = new Goal(1, "goal1", 1, false, null, true, Calendar.getInstance(), false,
                GoalContext.getGoalContextById(1),0, Goal.RecurrencePattern.NONE, null, null);
        ...
        goalRepository.save(new Goal(1, "goalTextChanged", 2, false, null, true, Calendar.getInstance(), false,
                GoalContext.getGoalContextById(3), 0, Goal.RecurrencePattern.NONE, null, null));
    ...
    public void observeSaveMultipleGoals() {
        ...
        List<Goal> goalsToSave = List.of(
                new Goal(null, "goal1", 1, false, null, true, Calendar.getInstance(), false, GoalContext.getGoalContextById(2),0, Goal.RecurrencePattern.NONE, null, null),
                new Goal(null, "goal2", 2, false, null, true, Calendar.getInstance(), false, GoalContext.getGoalContextById(4), 0, Goal.RecurrencePattern.NONE, null, null)
        );
