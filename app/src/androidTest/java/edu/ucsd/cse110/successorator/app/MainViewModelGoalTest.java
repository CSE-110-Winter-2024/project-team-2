...
public class MainViewModelGoalTest {
    ...
    public void getGoalsAndAppend() {
        ...
        Goal goal1 = new Goal(1, "Goal 1", 1, false, null, true, Calendar.getInstance(), false, GoalContext.getGoalContextById(1), 0, Goal.RecurrencePattern.NONE, null, null);
        ...
        Goal goal2 = new Goal(2, "Goal 2", 2, false, null, true, Calendar.getInstance(), false, GoalContext.getGoalContextById(1), 0, Goal.RecurrencePattern.NONE, null, null);
